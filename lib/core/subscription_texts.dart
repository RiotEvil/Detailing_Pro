      ...
      case AppPlan.free:
        return [
          ...
          _pick(context, {
            ...
            'ru': 'До 10 активных заказов в месяц',
            'pl': 'Do 10 aktywnych zlecen miesiecznie',
            'pt': 'Ate 10 pedidos ativos por mes',
            'tr': 'Aylik 10 aktif siparise kadar',
            'zh': '每月最多 10 个活跃订单',
            'es': 'Hasta 10 pedidos activos por mes',
            'it': 'Fino a 10 ordini attivi al mese',
            'de': 'Bis zu 10 aktive Auftrage pro Monat',
          }),
          _pick(context, {
